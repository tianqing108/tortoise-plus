...
==============================
tortoise-plus Quart integration
==============================

We have a lightweight integration util ``tortoise.contrib.quart`` which has a single function ``register_tortoise`` which sets up tortoise-plus on startup and cleans up on teardown.
...
.. code-block:: sh
    ...
    QUART_APP=main quart
        ...
        Commands:
          generate-schemas  Populate DB with tortoise-plus schemas.
